...
def get_resnet(type):
    ...
    if type == 18:
        ...
        model_file = 'DenseDesc/resnet34-333f7ec4.pth'   # Pre-trained on ImageNet
        model_res_net = wideresnet.resnet34()
    elif type == 50:
        model_file = 'DenseDesc/resnet50_places365.pth.tar'
...
def get_mobilenet(pre_trained=True):
    ...
    if pre_trained:
        model_file = 'DenseDesc/mobilenet_v2_best.pth.tar'
        checkpoint = torch.load(model_file, map_location=lambda storage, loc: storage)
